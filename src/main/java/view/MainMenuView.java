...
public class MainMenuView {
    ...
    public MainMenuView(Stage primaryStage) {
        ...
        ImageView offline_btn = new ImageView("/img/play/play.png");
        ...
        IV.setImage(new Image("/img/cross.png"));
        IV.setFitHeight(200);
        IV.setFitWidth(200);
        ...
        IV2.setImage(new Image("/img/circle.png"));
        ...
        IV4.setImage(new Image("/img/grid.gif"));
